    ...
    return AppBar(
      ...
      title: subtitle != null
          ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text(subtitle!, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.normal, color: AppColors.textSecondary)),
            ])
...
class RoleBadge extends StatelessWidget {
  ...
  Color get _color {
    switch (role) {
      case 'admin': return AppColors.adminBadge;
      case 'reporter': return AppColors.reporterBadge;
      default: return AppColors.userBadge;
    }
  }
